# -*- coding: utf-8 -*-
"""
Created on Sat Jul 27 00:02:50 2024
...
st.markdown("""
    <style>
        .footer {
            ...
            background-color: #ae7f63; /* Custom color for footer */
        ...
        .title {
            text-align: center;
            color: #FF5733; /* Catchy color for title */
            font-size: 60px;
            font-weight: bold;
            margin-top: 20px;
            margin-bottom: 20px;
            text-shadow: 2px 2px #000000; /* Add shadow to make the text pop */
        }
    </style>
...
with st.sidebar:
    selected = option_menu('We Care : Multiple Disease Prediction System',
...
st.markdown('<div class="title">We Care : Multiple Disease Prediction System</div>', unsafe_allow_html=True)
...
st.markdown("""
    <div class="footer">
        <p>Created by Omkar Borate &copy; 2024. All rights reserved.</p>
    </div>
    """, unsafe_allow_html=True)